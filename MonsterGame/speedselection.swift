...
class speedselection : SKScene
{
    var single = SKSpriteNode()
    var double = SKSpriteNode()
    var multiButton = SKSpriteNode()
    let singleTex = SKTexture(imageNamed: "speed1")
    
    let doubleTex = SKTexture(imageNamed: "speed2")
